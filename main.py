...
async def main() -> None:
    ...
    if not session_str:
        raise RuntimeError("Nenhuma sessão encontrada no MongoDB. Execute setup_session.py primeiro.")
    ...
    if not await client.is_user_authorized():
        raise RuntimeError("Sessão expirada. Execute setup_session.py novamente.")
